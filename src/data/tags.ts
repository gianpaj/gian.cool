...
export const TAG_METADATA: Record<Tag, { label: string; description: string }> =
  {
    ...
    coding_agent: {
      label: "Coding Agent",
      description: "AI agents for coding",
    },
    terminal: {
      label: "Terminal",
      description: "CLI tools and shell workflows",
    },
    game: { label: "Game", description: "Game development and AI agents" },
    ...
    projects: {
      label: "Projects",
      description: "Build logs and project write-ups",
    },
    benchmark: {
      label: "Benchmark",
      description: "Performance and measurements",
    },
    ...
    models: {
      label: "Models",
      description: "Model-level analysis and results",
    },
  };
